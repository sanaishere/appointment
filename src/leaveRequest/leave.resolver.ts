...
export class LeaveResolver {
    ...
    async updateRequest(@Args('reqInput') input:RequestInput,@Args('id') id:string){
    ...
    async updateStatusByAdmin(@Args('status') status:UpdateLeaveStatus,@Args('id') id:string){
