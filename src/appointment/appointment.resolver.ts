...
export class AppointmentResolver {
  ...
  async update(
    @Args('id') appointmentId: string,
    @Args('input') input: UpdateStaffAppointment,
    @Context() ctx,
  ) {
  ...
  async updateStatus(
    @Args('id') appointmentId: string,
    @Args('input') input: UpdateAppointmentStatus,
    @Context() ctx,
  ) {
  ...
  async todayFreeTimesOfStaff(
    @Args('staffName') staffName: string,
    @Args('date') date: string,
  ) {
